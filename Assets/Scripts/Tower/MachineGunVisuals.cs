...
public class MachineGunVisuals : MonoBehaviour
{
    ...
    [SerializeField] ParticleSystem onAttackFx;
    ...
    private IEnumerator RecoilCo(Transform gunPoint)
    {
        ...
        {
            objectToMove.localPosition = Vector3.MoveTowards(objectToMove.localPosition, originalPosition, recoverSpeed * Time.deltaTime);
